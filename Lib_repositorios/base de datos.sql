...
('Juan P�rez', 'Cajero', '3001234567', 'juan@comicstore.com', '2023-01-15'),
('Laura G�mez', 'Vendedora', '3019876543', 'laura@comicstore.com', '2022-05-20'),
...
('Andr�s D�az', 'Vendedor', '3167896543', 'andres@comicstore.com', '2024-02-28');

-- CATEGORIAS
INSERT INTO [Categorias] ([Nombre], [Descripcion], [Estado], [Prioridad], [Fecha_creacion]) VALUES
('Superh�roes', 'Comics de Marvel y DC', 1, 1, '2024-04-24'),
('Manga', 'Historietas japonesas', 1, 2, '2024-04-24'),
('Independiente', 'Editoriales independientes', 1, 3, '2024-04-24'),
('Novela Gr�fica', 'Historias largas y autoconclusivas', 1, 4, '2024-04-24'),
('Infantil', 'Comics para ni�os', 1, 5, '2024-04-24');
...
('Estanter�a A', 40, 'Zona de ventas', 'Comic', '2024-04-24'),
('Estanter�a B', 30, 'Zona de ventas', 'Comic', '2024-04-24'),
('Dep�sito Extra', 60, 'S�tano', 'Manga', '2024-04-24');
...
('Ana L�pez', 'ana@email.com', 'Cra 12 #8-10', '3219876543', '2024-03-25', 2),
('Luis Ram�rez', 'luis@email.com', 'Av 15 #9-30', '3226547890', '2024-04-10', 3),
('Claudia R�os', 'claudia@email.com', 'Calle 7 #11-22', '3008765432', '2024-03-15', 4),
...
('Batman A�o Uno', 'DC', 'Frank Miller', 'David Mazzucchelli', 45000, 1, 1),
...
('Distribuciones Comics SAS', '3124567890', 'ventas@comics.com', 'Calle 20 #4-30', 'Bogot�'),
('Manga Express', '3112345678', 'contacto@mangaexpress.com', 'Av 3 #15-40', 'Medell�n'),
('Marvel Colombia', '3209876543', 'info@marvelcol.com', 'Cra 7 #45-21', 'Cali'),
('DC Distribuciones', '3107654321', 'ventas@dcdistribuciones.com', 'Calle 30 #8-10', 'Bogot�'),
...
(60000, 2, 120000, 0, 'Novela Gr�fica', 5, 5);
...
('2024-04-24', 'Batman A�o Uno', 1, 45000, 'Entregada', 1),
...
('2024-04-24', 'Activa', 'Descuento directo', 'General', 'Aplica a toda la categor�a', 1, 1),
('2024-04-23', 'Activa', 'Descuento directo', 'Especial', 'Solo para este comic', 2, 2),
('2024-04-22', 'Activa', 'Descuento directo', 'General', 'Aplica a toda la categor�a', 3, 3),
('2024-04-21', 'Inactiva', 'C�digo promocional', 'General', 'Necesita c�digo para aplicar', 4, 4),
