...
namespace ut_presentacion.Nucleo
{
        ...
        public static class EntidadesNucleo
        {
            ...
            // Entidades con dependencias - Usar IDs válidos que existen en la BD
            public static Clientes? Clientes()
            {
                ...
                entidad.Membresia = 1; // Usar ID existente en la BD
                return entidad;
            }
            ...
            public static Comics? Comics()
            {
                ...
                entidad.Categoria = 1; // Usar ID existente en la BD
                entidad.Inventario = 1; // Usar ID existente en la BD
                return entidad;
            }
            ...
            public static Ventas? Ventas()
            {
                ...
                entidad.Empleado = 1; // Usar ID existente en la BD
                entidad.Proveedor = 1; // Usar ID existente en la BD
                entidad.Membresia = 1; // Usar ID existente en la BD
                return entidad;
            }
            ...
            public static DetalleVentas? DetalleVentas()
            {
                ...
                entidad.Venta = 1; // Usar ID existente en la BD
                entidad.Comic = 1; // Usar ID existente en la BD
                return entidad;
            }
            ...
            public static Compras? Compras()
            {
                ...
                entidad.Cliente = 1; // Usar ID existente en la BD
                return entidad;
            }
            ...
            public static DetalleCompras? DetalleCompras()
            {
                ...
                entidad.Compra = 1; // Usar ID existente en la BD
                entidad.Comic = 1; // Usar ID existente en la BD
                entidad.Pago = 1; // Usar ID existente en la BD
                return entidad;
            }
            ...
            public static Devoluciones? Devoluciones()
            {
                ...
                entidad.Cliente = 1; // Usar ID existente en la BD
                entidad.Detalle_compra = 1; // Usar ID existente en la BD
                return entidad;
            }
            ...
            public static Comic_promociones? Comic_promociones()
            {
                ...
                entidad.Promocion = 1; // Usar ID existente en la BD
                entidad.Comic = 1; // Usar ID existente en la BD
                return entidad;
            }
        }
